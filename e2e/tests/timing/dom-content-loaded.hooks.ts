...
const hooks: RequestFixtures = {
	...
	script: js`
		...
		(function (evolv) {
			...
			evolv.javascript.variants['evolv_web_dcvu1glgo_sr5zokh9h'].timing = 'dom-content-loaded';

			evolv.javascript.variants['evolv_web_dcvu1glgo'] = function (resolve, reject) {
				console.log('Context applied: evolv_web_dcvu1glgo');
			};

			evolv.javascript.variants['evolv_web_dcvu1glgo'].timing = 'immediate';
		})(window.evolv);
	`,
	style: css`
